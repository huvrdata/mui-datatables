...
const descriptions = {
  ...
  'Column Filters':
    'Apply initial filters, customize per-column filter options, and respond to filter changes with callbacks.',
  'Column Option Update':
    'Dynamically update column options like filterOptions, filterList, and visibility at runtime.',
  'Column Sort':
    'Implement custom sort comparators to handle non-standard data types like string-encoded ages and arrays.',
  Component: 'Render editable components (TextFields, Selects, Switches) inside table cells using customBodyRender.',
  'CSV Export':
    'Customize CSV download formatting with onDownload, downloadOptions, and column-level CSV display control.',
  'Custom Action Columns':
    'Add Edit, Delete, and Add action buttons to rows using empty columns with customBodyRenderLite.',
  'Custom Components':
    'Override built-in components like the filter list, tooltips, checkboxes, and view-columns dialog.',
  ...
  'Customize Footer':
    'Replace the default footer with a custom component and add aggregate calculations in the table body footer.',
  ...
  'Customize Sorting':
    'Use customSort for client-side sorting logic with sortOrder, sortThirdClickReset, and sortDescFirst options.',
  'Customize Styling':
    'Apply custom themes via ThemeProvider and conditional cell/row styles with setCellProps and setRowProps.',
  ...
  'Expandable Rows':
    'Add expandable row content with renderExpandableRow, isRowExpandable, and expansion state control.',
  ...
  'Large Data Set':
    'Optimize performance for 5000+ rows with debounceSearchRender, jumpToPage, and customBodyRenderLite.',
  ...
  'Selectable Rows':
    'Configure row selection with selectableRows, isRowSelectable, hide checkboxes, and selection callbacks.',
  'ServerSide Filters':
    'Implement server-side filtering with confirmFilters, customFilterDialogFooter, and filter confirm/reset.',
  'ServerSide Pagination':
    'Handle pagination server-side with onTableChange, managing page/sort state and loading indicators.',
